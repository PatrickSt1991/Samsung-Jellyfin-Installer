...
⚠️ Samsung endpoint outage: Tizen 7+ cannot generate or install signed certificates
</h2>
...
|------------|----------------------------------------|--------------------------------------------|
| **Stable** | [v1.7.7](https://github.com/PatrickSt1991/Samsung-Jellyfin-Installer/releases/tag/v1.7.7)           | Recommended for most users                 |
