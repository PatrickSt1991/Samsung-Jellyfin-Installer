...
|------------|---------------------------------------------------------------------|------------------------------|
| **Stable** | [v1.8.6.0](https://github.com/PatrickSt1991/Samsung-Jellyfin-Installer/releases/tag/v1.8.6.0)                                        | Recommended for most users   |
| **Beta**   | [v1.8.6.3-beta](https://github.com/PatrickSt1991/Samsung-Jellyfin-Installer/releases/tag/v1.8.6.3-beta)                                            | Includes new features        |
