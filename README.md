...
|------------|---------------------------------------------------------------------|------------------------------|
| **Stable** | [v1.8.7.0](https://github.com/Jellyfin2Samsung/Samsung-Jellyfin-Installer/releases/tag/v1.8.7.0)                                        | Recommended for most users   |
| **Beta**   | [v1.8.7.5-beta](https://github.com/Jellyfin2Samsung/Samsung-Jellyfin-Installer/releases/tag/v1.8.7.5-beta)                                            | Includes new features        |
