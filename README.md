...
|------------|----------------------------------------|--------------------------------------------|
| **Stable** | [v1.6.6](https://github.com/PatrickSt1991/Samsung-Jellyfin-Installer/releases/tag/v1.6.6)           | Recommended for most users                 |
| **Beta**   | [v1.6.8-beta](https://github.com/PatrickSt1991/Samsung-Jellyfin-Installer/releases/tag/v1.6.8-beta)               | Includes new features, may be less stable  |
