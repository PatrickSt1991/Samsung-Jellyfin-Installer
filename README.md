...
|------------|----------------------------------------|--------------------------------------------|
| **Stable** | [$STABLE_TAG\](https://github.com/PatrickSt1991/Samsung-Jellyfin-Installer/releases/tag/v1.6.5)         | Recommended for most users                 |
| **Beta**   | [$BETA_TAG\](#)             | Includes new features, may be less stable  |
